...
class MyEquipmentPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: user == null
          ? const Center(child: Text('Please log in to view your equipment.'))
          : StreamBuilder<QuerySnapshot>(
              ...
              builder: (context, snapshot) {
                ...
                final equipmentDocs = docs.where((doc) {
                  final data = doc.data() as Map<String, dynamic>;
                  final productType = data['productType'] ?? '';
                  final category = data['category'] ?? '';
                  return productType == 'equipment' || category == 'equipment';
                }).toList();

                if (equipmentDocs.isEmpty) {
                  return const Center(
                    child: Text('You have not listed any equipment yet.'),
                  );
                }
                ...
                return ListView.separated(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final name =
                        data['name'] ?? data['productName'] ?? 'Equipment';
